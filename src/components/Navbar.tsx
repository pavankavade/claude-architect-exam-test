    ...
    <header className="sticky top-0 z-50 backdrop-blur-md bg-[#090e17]/85 border-b border-[#23344e] transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2.5 group">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-tr from-sky-500 to-indigo-500 flex items-center justify-center text-white shadow-md shadow-sky-500/20 group-hover:scale-105 transition-transform">
            <Headphones className="w-4 h-4" />
          </div>
          <div>
            <div className="font-bold text-slate-100 text-sm leading-tight tracking-tight flex items-center gap-1.5">
              Claude Certified Architect
              <span className="text-[9px] font-semibold uppercase tracking-wider px-1 py-0.2 rounded bg-sky-500/20 text-sky-400 border border-sky-500/30">
                Practice Audio
              </span>
            </div>
            <div className="text-[11px] text-slate-400 font-medium">Foundations Exam Simulator • 88 Questions</div>
          </div>
        </Link>
